...
cp "$SCRIPT_DIR/DFRobot_GP8XXX.py" "$INSTALL_DIR/" 2>/dev/null || echo "Warning: DFRobot_GP8XXX.py not found. Please copy it manually to $INSTALL_DIR/"
...
echo "2. Ensure DFRobot_GP8XXX.py is in $INSTALL_DIR/"
